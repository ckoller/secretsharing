...
from app.api.ceps_speed.strategies.sharing import BooleanSharingStrategy, BooleanLayerSharingStrategy
...
class TestCepsBoolLayer(TestCase):
    ...
    def test_and_00(self):
        ...
        protocol_name = 'ceps'
        circuit_id = 10
        circuit_input = json.dumps([0, 0])

        self.start_test_server(player_count)
        start_parties_in_gnome_shells(2, player_count, protocol_type)

        setup_protocol(protocol_name, player_count, protocol_type, circuit_id, circuit_input)
