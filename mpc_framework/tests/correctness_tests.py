...
class TestCepsSpeedBoolLayer(TestCase):
    ...
    def test_and_0_0(self):
        ...
        input = json.dumps([0,0])
        # choose protocol and input for players
        setup_protocol('ceps_speed', number_of_players, circuit_type='bool', circuit_id=2, circuit_input=input)
...
class TestCepsBoolLayer(TestCase):
    ...
    def test_AES_ceps(self):
        ...
        setup_protocol(protocol_name='ceps', number_of_players=player_count, circuit_type='bool', circuit_id=8, circuit_input=input)
